<template>
  <div id="todolist" >
    <div id="heading" class="container">
      <b-navbar class="border-bottom border-secondary">
        ...
        <b-navbar class="ml-auto">
          <button class="btn btn-secondary mt-5" @click="inputDisplay">
            Add
          </button>
        </b-navbar>
      </b-navbar>
    ...
    <div class="row justify-content-around justify-content-sm-center">
      <div
        v-for="(item, index) in updateTask"
        :key="index"
        style="width: 18rem"
      ...
      <div class="d-flex justify-content-center">
        ...
        >
          ...
          <div class="d-flex justify-content-around mt-4">
            ...
            <button class="btn btn-secondary" @click="cancelTask">
              Cancel
            </button>
          </div>
        </form>
